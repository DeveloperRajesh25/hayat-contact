    ...
    <section className="py-24 bg-white border-y border-zinc-100">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center mb-20">
          <p className="text-[10px] text-brand-gold uppercase tracking-[0.3em] font-medium mb-4">Portfolio in Motion</p>
        ...
        <div className="mt-16 text-center">
          <motion.a 
            ...
            viewport={{ once: true }}
            className="text-[10px] text-zinc-400 font-sans tracking-[0.2em] uppercase hover:text-brand-gold transition-colors pb-1 border-b border-transparent hover:border-brand-gold"
          >
