  ...
  return (
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4 text-center max-w-7xl">
        <div className="mb-20">
          <p className="text-[10px] text-brand-gold uppercase tracking-[0.3em] font-medium mb-4">Our Expertise</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {services.map((s, i) => (
            ...
            >
              ...
              <div className="text-brand-gold text-lg mb-8">{s.icon}</div>
              ...
              <div className="flex items-end justify-between border-t border-zinc-100 pt-6 mt-auto">
                <div>
                  ...
                  <span className="text-xl font-serif text-brand-gold">{s.price}</span>
                </div>
                <a 
                  href="#consultation-form"
                  className="text-[10px] pb-1 border-b border-transparent uppercase tracking-[0.2em] text-zinc-400 group-hover:text-brand-gold group-hover:border-brand-gold transition-all"
                >
                  Get Quote
                </a>
              </div>
